...
plot \
    '../data/castor/q-ll.txt' using 1:(100*$2/$2)  with linespoints notitle ls 7 lw 3 dt (1,1), \
    '../data/castor/q-ll.txt' using 1:(100*$3/$2)  with linespoints notitle ls 1 lw 3 dt (1,1), \
    '../data/castor/q-ll.txt' using 1:(100*$4/$2)  with linespoints notitle ls 2 lw 3 dt 1, \
	'../data/castor/q-ll.txt' using 1:(100*$6/$2)  with linespoints notitle ls 8 lw 3 dt 1
...
plot \
    '../data/castor/q-ll.txt' using 1:(100*$7/$7)  with linespoints notitle ls 7 lw 3 dt (1,1), \
    '../data/castor/q-ll.txt' using 1:(100*$8/$7)  with linespoints notitle ls 1 lw 3 dt (1,1), \
    '../data/castor/q-ll.txt' using 1:(100*$9/$7)  with linespoints notitle ls 2 lw 3 dt 1, \
	'../data/castor/q-ll.txt' using 1:(100*$11/$7) with linespoints notitle ls 8 lw 3 dt 1
...
plot \
    '../data/castor/q-ll.txt' using 1:(100*$12/$12)  with linespoints notitle ls 7 lw 3 dt (1,1), \
    '../data/castor/q-ll.txt' using 1:(100*$13/$12)  with linespoints notitle ls 1 lw 3 dt (1,1), \
    '../data/castor/q-ll.txt' using 1:(100*$14/$12)  with linespoints notitle ls 2 lw 3 dt 1, \
	'../data/castor/q-ll.txt' using 1:(100*$16/$12)  with linespoints notitle ls 8 lw 3 dt 1
