...
set output "linkedlists-orc-castor.eps"
...
plot \
    '../data/castor/set-ll-1k-ho-orc.txt'  using 1:($2/1e6)  with linespoints notitle ls 13 lw 3 dt 1, \
    '../data/castor/set-ll-1k-hsh-orc.txt' using 1:($2/1e6)  with linespoints notitle ls 14 lw 3 dt 1, \
	'../data/castor/set-ll-1k-tbkp-orc.txt' using 1:($2/1e6)  with linespoints notitle ls 3 lw 3 dt 1, \
...
set label at first 1,2.5 front boxed left offset -0.5,-0.1 "2.5"
set label at graph 0.5,1.075 center font "Helvetica-bold,18" "  i=5% r=5% l=90%"

plot \
    '../data/castor/set-ll-1k-ho-orc.txt'   using 1:($3/1e6)  with linespoints notitle ls 13 lw 3 dt 1, \
    '../data/castor/set-ll-1k-hsh-orc.txt'  using 1:($3/1e6)  with linespoints notitle ls 14 lw 3 dt 1, \
	'../data/castor/set-ll-1k-tbkp-orc.txt' using 1:($3/1e6)  with linespoints notitle ls 3 lw 3 dt 1, \
...
unset label
set style textbox opaque noborder fillcolor rgb "white"
set label at first 1,3.0 front boxed left offset -0.5,-0.1 "3"
set label at graph 0.5,1.075 center font "Helvetica-bold,18" "  i=0% r=0% l=100%"

plot \
    '../data/castor/set-ll-1k-ho-orc.txt'   using 1:($4/1e6)  with linespoints notitle ls 13 lw 3 dt 1, \
    '../data/castor/set-ll-1k-hsh-orc.txt'  using 1:($4/1e6)  with linespoints notitle ls 14 lw 3 dt 1, \
	'../data/castor/set-ll-1k-tbkp-orc.txt' using 1:($4/1e6)  with linespoints notitle ls 3 lw 3 dt 1, \
